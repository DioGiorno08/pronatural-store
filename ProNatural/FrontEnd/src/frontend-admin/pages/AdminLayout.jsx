...
function AdminSidebar() {
  ...
  return (
    <aside className="w-[240px] flex-shrink-0 bg-[#161b1e] border-r border-white/5 min-h-screen flex flex-col py-6">
...
function AdminTopbar() {
  ...
  const notifications = notifsEnabled ? [
    { id: 1, title: 'Nueva Venta Registrada: ORD-8924', time: 'Hace 5 min' },
    { id: 2, title: 'Stock Bajo: Cápsulas de Espresso', time: 'Hace 1 hora' }
  ] : [];
  return (
    <header className="h-[72px] flex items-center justify-end px-8 flex-shrink-0 bg-[#0d1114]">
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          <button onClick={() => { setShowProfile(!showProfile); setShowNotif(false); }} className="flex items-center gap-3 cursor-pointer hover:bg-white/5 p-1 pr-3 rounded-full transition-colors">
            <div className="w-8 h-8 bg-[#1b4332] text-[#4ade80] rounded-full flex items-center justify-center text-[13px] font-bold">
  ...
  return (
    <div className="flex h-screen bg-[#0d1114] font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden relative">
        ...
        <footer className="absolute bottom-0 left-0 right-0 px-8 py-4 flex items-center justify-between pointer-events-none">
