...
export default function InventoryManagement() {
  ...
  const topInventory = products.slice(0, 4).map(p => ({
    id: p.id,
    ...
    <div className="max-w-[1200px] mx-auto pb-12">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-5 py-2.5 bg-transparent border border-white/10 text-gray-300 text-[13px] font-medium rounded-[10px] hover:bg-white/5 transition-colors cursor-pointer">
          ...
          <button className="flex items-center gap-2 px-5 py-2.5 bg-[#75e29f] hover:bg-[#5bc285] text-[#0a110d] text-[13px] font-bold rounded-[10px] transition-colors cursor-pointer">
            + Añadir Producto
          </button>
        </div>
      </div>
      ...
      <div className="bg-[#161b1e] rounded-[14px] p-6 border border-white/5">
