          ...
          <div className="flex flex-col gap-4 sticky top-[30px] self-start">
            ...
            <div className="bg-[#161b1e] border border-white/5 rounded-[12px] p-5">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                >
                  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
                  <span className="text-[11px] font-bold uppercase">WOMPI</span>
                </button>
              </div>
              {paymentMethod === 'Efectivo' && (
                <>
